    ...
    ui(new Ui::WelcomeView)
{
    ...
    ui->labelAbout->setText("OSINT Template Engine is a research-grade tool for Information gathering & Attack Surface Mapping using customizable templates."
                            ...
                            "<br>"
                            "<li>  • Learn how to develop your own templates <a href=\"https://github.com/OTE/wiki\">here</a>."
                            "<br>"
                            "<li>  • Learn how to modify existing templates to your liking <a href=\"https://github.com/OTE/wiki\">here</a>."
                            "<br>"
                            "<li>  • Learn how to create extractors <a href=\"https://github.com/OTE/wiki\">here</a>."
                            "<br>"
