...
namespace ModuleInfo {
    struct Bgpview{
        ...
        QMap <QString, QString> flags = {{"ip", "ip-address"}, {"ip prefix", "ip-address/cdir"},
                                         {"asn", "asn"}, {"asn prefixes", "asn prefixes"}, {"asn peers", "asn"},
                                         {"asn peers", "asn"}, {"asn upstreams", "asn"}, {"asn downstreams", "asn"},
                                         {"asn ixs", "ixs"}, {"query", "query term"}};
    };
}
