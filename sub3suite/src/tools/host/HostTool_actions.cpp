...
void HostTool::openInBrowser(){
    foreach(const QModelIndex &index, selectionModel->selectedIndexes())
        QDesktopServices::openUrl(QUrl("https://"+index.data().toString(), QUrl::TolerantMode));
}

void HostTool::removeResults(){
...
void HostTool::saveResults(const RESULT_TYPE &result_type){
...
void HostTool::saveSelectedResults(){
    QString filename = QFileDialog::getSaveFileName(this, tr("Save To File"), "./");
    if(filename.isEmpty()){
        qDebug() << "ACTIVE: Failed to getSaveFileName";
        return;
...
void HostTool::copyResults(const RESULT_TYPE &result_type){
...
void HostTool::copySelectedResults(){
    QClipboard *clipboard = QGuiApplication::clipboard();
    QString data;
...
void HostTool::extract(bool subdomain, bool tld){
    QClipboard *clipboard = QGuiApplication::clipboard();
...
void HostTool::extractSelected(bool subdomain, bool tld){
    QClipboard *clipboard = QGuiApplication::clipboard();
    QSet<QString> extracts;
...
void HostTool::sendSelectedToEngine(const TOOL &engine, const RESULT_TYPE &result_type){
    QSet<QString> targets;
...
void HostTool::sendToEnum(const ENUMERATOR &tool){
    QSet<QString> targets;
...
void HostTool::sendSelectedToEnum(const ENUMERATOR &tool){
    QSet<QString> targets;
...
void HostTool::onReceiveTargets(QSet<QString> targets, RESULT_TYPE resultType){
