...
void SSLEnum::on_buttonStart_clicked(){
    ...
    case TARGET_SSLCERT:
    {
        ...
        case MODULE::CRTSH:
        {
            ...
            connect(this, &SSLEnum::pauseScanThread, crtsh, &AbstractOsintModule::onPause);
            /* ... */
...
void SSLEnum::on_comboBoxTargetType_currentIndexChanged(int index){
...
void SSLEnum::onEnumerationComplete(){
    ui->buttonStart->setEnabled(true);
    ui->buttonStop->setDisabled(true);
}

void SSLEnum::onInfoLogTxt(QString log){
    ui->plainTextEditLogs->appendPlainText(log);
}

void SSLEnum::onErrorLogTxt(QString log){
