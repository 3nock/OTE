    ...
    raw_model(new QStandardItemModel)
{
    ...
    project_explorer->setIcon(QIcon(":/img/res/icons/project.png"));
    active_explorer->setFont(font);
    active_explorer->setForeground(Qt::white);
    active_explorer->setIcon(QIcon(":/img/res/icons/gear.png"));
    passive_explorer->setFont(font);
    passive_explorer->setForeground(Qt::white);
    passive_explorer->setIcon(QIcon(":/img/res/icons/gear.png"));
    enums_explorer->setFont(font);
    enums_explorer->setForeground(Qt::white);
    enums_explorer->setIcon(QIcon(":/img/res/icons/gear.png"));
    custom_explorer->setFont(font);
    custom_explorer->setForeground(Qt::white);
    custom_explorer->setIcon(QIcon(":/img/res/icons/gear.png"));

    activeHost_explorer->setIcon(QIcon(":/img/res/icons/domain.png"));
    activeWildcard_explorer->setIcon(QIcon(":/img/res/icons/wildcard.png"));
    activeDNS_explorer->setIcon(QIcon(":/img/res/icons/dns.png"));
    activeA_explorer->setIcon(QIcon(":/img/res/icons/ipv4.png"));
    activeAAAA_explorer->setIcon(QIcon(":/img/res/icons/ipv6.png"));
    activeNS_explorer->setIcon(QIcon(":/img/res/icons/ns.png"));
    activeMX_explorer->setIcon(QIcon(":/img/res/icons/mx.png"));
    activeTXT_explorer->setIcon(QIcon(":/img/res/icons/txt.png"));
    activeCNAME_explorer->setIcon(QIcon(":/img/res/icons/cname.png"));
    activeSRV_explorer->setIcon(QIcon(":/img/res/icons/srv.png"));
    activeSSL_explorer->setIcon(QIcon(":/img/res/icons/ssl.png"));
    activeSSL_sha1_explorer->setIcon(QIcon(":/img/res/icons/hash.png"));
    activeSSL_sha256_explorer->setIcon(QIcon(":/img/res/icons/hash.png"));
    activeSSL_altNames_explorer->setIcon(QIcon(":/img/res/icons/domain.png"));
    activeURL_explorer->setIcon(QIcon(":/img/res/icons/url.png"));
    passiveSubdomainIp_explorer->setIcon(QIcon(":/img/res/icons/domain.png"));
    passiveSubdomain_explorer->setIcon(QIcon(":/img/res/icons/domain.png"));
    passiveA_explorer->setIcon(QIcon(":/img/res/icons/ipv4.png"));
    passiveAAAA_explorer->setIcon(QIcon(":/img/res/icons/ipv6.png"));
    passiveCidr_explorer->setIcon(QIcon(":/img/res/icons/cidr.png"));
    passiveNS_explorer->setIcon(QIcon(":/img/res/icons/ns.png"));
    passiveMX_explorer->setIcon(QIcon(":/img/res/icons/mx.png"));
    passiveTXT_explorer->setIcon(QIcon(":/img/res/icons/txt.png"));
    passiveCNAME_explorer->setIcon(QIcon(":/img/res/icons/cname.png"));
    passiveEmail_explorer->setIcon(QIcon(":/img/res/icons/email.png"));
    passiveUrl_explorer->setIcon(QIcon(":/img/res/icons/url.png"));
    passiveAsn_explorer->setIcon(QIcon(":/img/res/icons/asn.png"));
    passiveSSL_explorer->setIcon(QIcon(":/img/res/icons/ssl.png"));
    enumIp_explorer->setIcon(QIcon(":/img/res/icons/ip.png"));
    enumASN_explorer->setIcon(QIcon(":/img/res/icons/asn.png"));
    enumCIDR_explorer->setIcon(QIcon(":/img/res/icons/cidr.png"));
    enumNS_explorer->setIcon(QIcon(":/img/res/icons/ns.png"));
    enumMX_explorer->setIcon(QIcon(":/img/res/icons/mx.png"));
    enumSSL_explorer->setIcon(QIcon(":/img/res/icons/ssl.png"));
    enumEmail_explorer->setIcon(QIcon(":/img/res/icons/email.png"));
    raw_explorer->setIcon(QIcon(":/img/res/icons/raw.png"));
    ///
    /// setting foreground
    ///
